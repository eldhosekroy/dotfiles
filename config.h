...
static const char *theme[]  = { "/home/cat/rice/newlook", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_t,      spawn,          {.v = theme } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	...
	{ 0, XK_Print,	                spawn,		SHCMD("import -window root /home/cat/Pictures/$(date | sed 's/ //g' | sed 's/://g').png") },
};
